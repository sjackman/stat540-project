...
# Aggregate the beta values of the probes for each CpG island.
# Input: 1.) normalized&Filtered beta-value data sets
# 2.) metadata
# Output: 1.) beta-value data set with CPGI attached
# 2.) beta-value CPGI-level data (mean and median)
#############################################################
...
str(ALL.dat)
# 'data.frame':  435739 obs. of  33 variables:
...
########### Edit the path!!!!!!!!!!!!!!!!!!!
save(cpgi.probes.Beta, file = 'Data/CPGI2Probe_betaList_normFilt.Rdata')
# rows = cpgi, columns = samples
save(cpgi.Beta.mean, file = 'Data/CPGI_betaMeanList_normFilt.Rdata')
save(cpgi.Beta.median, file = 'Data/CPGI_betaMedianList_normFilt.Rdata')
